...
# SECRET_KEY = 'django-insecure-o+dkn*(d)f1zgn-u6i_1ten*2!++=^t8-43-s$boqsq(xuw&4-'
SECRET_KEY = '$w+j!5rshcrl05n5pq33jv63pxo^r+%=1cxt-4ebzf61aq=qla'
...
DATABASES = {
    ...
    "default": {
        ...
        'NAME': 'acme2certifier',
        'USER': "root",
        'PASSWORD': "acme2certifierdevelop",
        'HOST': "localhost",
        'PORT': 43306,
...
LOGGING = {
    ...
    'handlers': {
        ...
        'test': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': 'test.log',  # Choose a file name and path
        },
    },
    'loggers': {
        'django.db.backends': {
